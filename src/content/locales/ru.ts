...
export const RU = {
  ...
  'settings.qualityHint': 'Авто следит за временем кадра и само выбирает, чем пожертвовать. Ниже — крупнее пиксель света и грубее тени, но ровнее ход.',
  'settings.debugOverlay': 'Отладочный оверлей',
  'settings.controls': 'Управление',
  'settings.touch': 'Касание',
  'settings.touch.auto': 'Авто',
  'settings.touch.on': 'Всегда',
  'settings.touch.off': 'Никогда',
  'settings.touchHint': 'Авто поднимает экранные стики при первом касании и убирает их, как только вы взялись за клавиши. Левый стик — идти, до упора — бежать; правый — куда смотреть.',
  ...
  'hint.moveTouch': 'Левый стик — идти, до упора — бежать. Правый — куда смотришь.',
  ...
  'inventory.helpTouch': 'Тащите пальцем между сумкой, слотами и поясом. Двойное касание — основное действие, долгое — весь список.',
  'inventory.cells': {
    one: '{count} ячейка',
    few: '{count} ячейки',
    many: '{count} ячеек',
