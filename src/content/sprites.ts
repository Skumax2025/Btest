...
export const SPRITES: Readonly<Record<string, PlaceholderSpec>> = {
  ...
  'item.knife': icon('#6b6f74', '#d9dde2', 1, 1),
  'item.crowbar': icon('#7a4a3a', '#c08a6a', 1, 2),
  'item.tray': icon('#8a8f7c', '#d3d8c4', 2, 1),
  'item.hood': icon('#4a4a52', '#8d8d99', 1, 1),
  'item.headlamp': icon('#3f4a54', '#f2e6b4', 1, 1),
  'item.respirator': icon('#5a5f56', '#b6bcae', 1, 1),
  'item.goggles': icon('#3a4650', '#9fd4e4', 1, 1),
  'item.jumpsuit': icon('#8a7a3a', '#d6c47c', 2, 2),
  'item.raincoat': icon('#3f6a70', '#8fc4c8', 2, 2),
  'item.cargopants': icon('#5d5a3f', '#a49f78', 1, 2),
  'item.jeans': icon('#3f4a68', '#8896b8', 1, 2),
  'item.sneakers': icon('#7a7a7a', '#dcdcdc', 1, 1),
  'item.vest.kevlar': icon('#4a4f3a', '#8d9478', 2, 2),
  'item.vest.plate': icon('#3a3d42', '#7c8189', 2, 2),
  'item.satchel': icon('#6a5a42', '#b39c78', 1, 2),
  'item.hikingpack': icon('#3f5a44', '#86ab8c', 2, 2),
  'item.stim': icon('#8a3f52', '#e79cb0', 1, 1),
  'item.ducttape': icon('#54544f', '#a0a09a', 1, 1),
  'item.glowstick': icon('#2f5a3a', '#9cf2b4', 1, 1),
  'item.radio': icon('#4f4438', '#c4a97e', 1, 2),
